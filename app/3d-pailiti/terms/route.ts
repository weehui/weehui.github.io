...
<head>
  <meta charset="utf-8" />
  <title>3D-PaiLiTi — Terms of Service</title>
...
<body>
  <header>
    ...
    <p class="muted">
      Product: <strong>3D-PaiLiTi</strong> &nbsp;|&nbsp; Company: <strong>Encoflow Digital Studio Sdn. Bhd.</strong><br />
Effective date: <strong>2025-10-20</strong> &nbsp;|&nbsp; Platforms: Android / iOS
  ...
  <section>
    ...
    <p>
      By downloading, accessing, or using <strong>3D-PaiLiTi</strong> (the “App” or “Service”), you agree to be bound by these Terms of Service (“Terms”).
  ...
  <section>
    ...
    <p>
      You are responsible for content you upload, submit, or generate using the Service (including images, video, text, 3D assets, and other materials).
    ...
    <p>
      You retain ownership of your content. You grant us a limited license to host, process, display, transmit, and transform your content as needed to operate and improve the Service and to provide features you request (e.g., rendering, exporting, or sharing).
    </p>
  </section>
